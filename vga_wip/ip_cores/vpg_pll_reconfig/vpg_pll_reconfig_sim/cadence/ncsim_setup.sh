...
TOP_LEVEL_NAME="vpg_pll_reconfig"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/mnt/66d5710d-4496-4a33-9d0e-8707450fe020/intelFPGA_lite/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/vpg_pll_reconfig/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"        -work vpg_pll_reconfig -cdslib ./cds_libs/vpg_pll_reconfig.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_mif_reader.v" -work vpg_pll_reconfig -cdslib ./cds_libs/vpg_pll_reconfig.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v"       -work vpg_pll_reconfig -cdslib ./cds_libs/vpg_pll_reconfig.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"        -work vpg_pll_reconfig -cdslib ./cds_libs/vpg_pll_reconfig.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vpg_pll_reconfig.v"                                                                                                     
fi
